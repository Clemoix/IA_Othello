                ...
                for k in range(-1,2):
                    for l in range(-1,2):
                        if not(k == 0 and l ==0): #On ne cherche pas sur lui-même
                            ...
                            while( i+(k*n)>=0 and i+(k*n)<len(plateau)   and   j+(l*n)>=0 and j+(l*n)<len(plateau[0]) #exeption si l'on sort du tableau
                                   and plateau[i+(k*n)][j+(l*n)] == pion_a_attaquer #Si on saut un pion
                                   ):
                                n += 1
                            #end while
                            if( i+(k*n)>=0 and i+(k*n)<len(plateau)   and   j+(l*n)>=0 and j+(l*n)<len(plateau[0]) #exeption si l'on sort du tableau
                                and plateau[i+(k*n)][j+(l*n)] == " " and n>=2   #n>=2 SINIFIE QUE L'ON SAUT AU MOINS 1 PION A ATTAQUER
                                ): 
                                m += 1
                ...
                for k in range(-1,2):
                    for l in range(-1,2):
                        if not(k == 0 and l ==0): #On ne cherche pas sur lui-même
                            ...
                            while( i+(k*n)>=0 and i+(k*n)<len(plateau)   and   j+(l*n)>=0 and j+(l*n)<len(plateau[0]) #exeption si l'on sort du tableau
                                   and plateau[i+(k*n)][j+(l*n)] != pion and plateau[i+(k*n)][j+(l*n)] != " " #Si on est sur un pion allié donc on peut modifier
                                   and not(isinstance(plateau[i+(k*n)][j+(l*n)], int))  
                                   ):
                                n += 1
                            #end while
                            if( i+(k*n)>=0 and i+(k*n)<len(plateau)   and   j+(l*n)>=0 and j+(l*n)<len(plateau[0]) #exeption si l'on sort du tableau
                                and plateau[i+(k*n)][j+(l*n)] == pion and n>=2   #n>=2 SINIFIE QUE L'ON SAUT AU MOINS 1 PION A ATTAQUER
                                ):
...
def min_max_ordi_positionnel(min_or_max, plateau, pion_de_lordi, pion_adverse, profondeur, nb_coup_joueur1, nb_coup_joueur2):
    ...
    """
    nombre_a_jouer = -1
    if(est_plein(plateau) == True or (nb_coup_joueur1 == 0 and nb_coup_joueur2 == 0) or profondeur <= 0): #Temps que ce n'est pas fini
    ...
    if(min_or_max == "max"):
        ...
        if(nb_coup_joueur1 == 0): #Si l'IA ne peut pas jouer alors
            ...
            result, _ = min_max_ordi_positionnel("min", plateau_bis, pion_de_lordi, pion_adverse, profondeur-1, nb_coup_joueur1, nb_coup_joueur2)
            ...
            for i in range(len(plateau)):
                for j in range(len(plateau[0])):
                    if( isinstance(plateau[i][j], int) ): #SI plateau[i][j] EST UN ENTIER // DONC UN COUP POSSIBLE
                        ...
                        plateau_bis = copy.deepcopy(plateau) #Réalise une deep copy du plateau de jeu
                        plateau_bis = jouer_numero(plateau_bis, pion_de_lordi, plateau[i][j]) #On simule le fait que l'on jou sur la case
                        plateau_bis = supprimer_coup_possible(plateau_bis)
                        plateau_bis, nb_coup_joueur2 = coup_possible(plateau_bis, pion_de_lordi, pion_adverse)
        ...
        if(nb_coup_joueur2 == 0): #Si l'IA ne peut pas jouer alors
            ...
            result, _ = min_max_ordi_positionnel("max", plateau_bis, pion_de_lordi, pion_adverse, profondeur-1, nb_coup_joueur1, nb_coup_joueur2)
            ...
            for i in range(len(plateau)):
                for j in range(len(plateau[0])):
                    if( isinstance(plateau[i][j], int) ): #SI plateau[i][j] EST UN ENTIER // DONC UN COUP POSSIBLE
                        ...
                        plateau_bis = copy.deepcopy(plateau) #Réalise une deep copy du plateau de jeu
                        plateau_bis = jouer_numero(plateau_bis, pion_adverse, plateau[i][j]) #On simule le fait que l'on jou sur la case
                        plateau_bis = supprimer_coup_possible(plateau_bis)
                        plateau_bis, nb_coup_joueur1 = coup_possible(plateau_bis, pion_adverse, pion_de_lordi)
...
def alpha_beta_ordi_positionnel(min_or_max, alpha, beta, plateau, pion_de_lordi, pion_adverse, profondeur, nb_coup_joueur1, nb_coup_joueur2):
    ...
    if(min_or_max == "max"):
        if( nb_coup_joueur1 == 0): #Si l'IA ne peut pas jouer alors
            ...
            score, _ = alpha_beta_ordi_positionnel("min", alpha, beta, plateau_bis, pion_de_lordi, pion_adverse, profondeur-1, nb_coup_joueur1, nb_coup_joueur2)
            if(score >= beta):
        ...
        if(nb_coup_joueur2 == 0): #Si l'IA ne peut pas jouer alors
            ...
            score, _ = alpha_beta_ordi_positionnel("max", alpha, beta, plateau_bis, pion_de_lordi, pion_adverse, profondeur-1, nb_coup_joueur1, nb_coup_joueur2)
            if(score <= alpha):
                return alpha, nombre_a_jouer
            if(score < beta):
                beta = score
...
def min_max_ordi_absolu(min_or_max, plateau, pion_de_lordi, pion_adverse, profondeur, nb_coup_joueur1, nb_coup_joueur2):
    ...
    if(min_or_max == "max"):
        ...
        if(nb_coup_joueur1 == 0): #Si l'IA ne peut pas jouer alors
            ...
            result, _ = min_max_ordi_absolu("min", plateau_bis, pion_de_lordi, pion_adverse, profondeur-1, nb_coup_joueur1, nb_coup_joueur2)
            valeur = max( valeur, result )
            return valeur, nombre_a_jouer
        else:
            for i in range(len(plateau)):
        ...
        if(nb_coup_joueur2 == 0): #Si l'IA ne peut pas jouer alors
            ...
            result, _ = min_max_ordi_absolu("max", plateau_bis, pion_de_lordi, pion_adverse, profondeur-1, nb_coup_joueur1, nb_coup_joueur2)
            valeur = min( valeur, result )
            return valeur, nombre_a_jouer
...
def alpha_beta_ordi_absolu(min_or_max, alpha, beta, plateau, pion_de_lordi, pion_adverse, profondeur, nb_coup_joueur1, nb_coup_joueur2):
    """ Fonction alpha-beta retournant la "valeur"  tactique (pour la récursivité) ainsi que
        le "nombre_a_jouer" après analyse suivant le profondeur pour "le pion_de_lordi"
        sur un des numéros avec la stratégie ABSOLU.
        ABSOLU : prise en compte de la différence du nombre de pions.
    ...
    if(min_or_max == "max"):
        if(nb_coup_joueur1 ==0): #Si l'IA ne peut pas jouer alors
            ...
            score, _ = alpha_beta_ordi_absolu("min", alpha, beta , plateau_bis, pion_de_lordi, pion_adverse, profondeur-1, nb_coup_joueur1, nb_coup_joueur2)
            if(score >= beta):
                return beta, nombre_a_jouer
            if(score > alpha):
                alpha = score
        ...
        if(nb_coup_joueur1 == 0): #Si l'IA ne peut pas jouer alors
            ...
            score, _ = alpha_beta_ordi_absolu("max", alpha, beta, plateau_bis, pion_de_lordi, pion_adverse, profondeur-1, nb_coup_joueur1, nb_coup_joueur2)
            if(score <= alpha):
                return alpha, nombre_a_jouer
            if(score < beta):
                beta = score
...
def min_max_ordi_mobilite(min_or_max, plateau, pion_de_lordi, pion_adverse, profondeur, nb_coup_joueur1, nb_coup_joueur2):
    """ Fonction min-max retournant la "valeur"  tactique (pour la récursivité) ainsi que
        le "nombre_a_jouer" après analyse suivant le profondeur pour "le pion_de_lordi"
    ...
    if(min_or_max == "max"):
        ...
        if(nb_coup_joueur1 == 0): #Si l'IA ne peut pas jouer alors
            ...
            result, _ = min_max_ordi_mobilite("min", plateau_bis, pion_de_lordi, pion_adverse, profondeur-1, nb_coup_joueur1, nb_coup_joueur2)
            valeur = max( valeur, result )    
            return valeur, nombre_a_jouer
            ...
            for i in range(len(plateau)):
                for j in range(len(plateau[0])):
                    if( isinstance(plateau[i][j], int) ): #SI plateau[i][j] EST UN ENTIER // DONC UN COUP POSSIBLE
                        ...
                        if(valeur != ancien_valeur): #si la valeur à changé alors on joue sur ce numéro
                            nombre_a_jouer = plateau[i][j]
                        if( ((i==0 and j==0) or (i==len(plateau)-1 and j==0) or (i==0 and j==len(plateau[0])-1) or (i==len(plateau)-1 and j==len(plateau[0])-1)) and valeur!=-10000000 ):  #DONC SI ON EST DANS UN COIN ON LE JOUE OBLIGATOIREMENT
                            nombre_a_jouer = plateau[i][j]
        ...
        if(nb_coup_joueur2 == 0): #Si l'IA ne peut pas jouer alors
            ...
            result, _ = min_max_ordi_mobilite("max", plateau_bis, pion_de_lordi, pion_adverse, profondeur-1, nb_coup_joueur1, nb_coup_joueur2)
            valeur = min( valeur, result )
            return valeur, nombre_a_jouer
...
def alpha_beta_ordi_mobilite(min_or_max, alpha, beta, plateau, pion_de_lordi, pion_adverse, profondeur, nb_coup_joueur1, nb_coup_joueur2):
    """ Fonction alpha-beta retournant la "valeur"  tactique (pour la récursivité) ainsi que
        le "nombre_a_jouer" après analyse suivant le profondeur pour "le pion_de_lordi"
        sur un des numéros avec la stratégie MOBILITE.
        MOBILITE : maximise le nombre de coups possibles et minimise les
    ...
    if(min_or_max == "max"):
        if(nb_coup_joueur1 == 0):
            ...
            score, _ = alpha_beta_ordi_mobilite("min", alpha, beta, plateau_bis, pion_de_lordi, pion_adverse, profondeur-1, nb_coup_joueur1, nb_coup_joueur2)
            if(score >= beta):
                return beta, nombre_a_jouer
            if(score > alpha):
                alpha = score
            ...
            for i in range(len(plateau)):
                for j in range(len(plateau[0])):
                    if( isinstance(plateau[i][j], int) ): #SI plateau[i][j] EST UN ENTIER // DONC UN COUP POSSIBLE
                        ...
                        score, _ = alpha_beta_ordi_mobilite("min", alpha, beta, plateau_bis, pion_de_lordi, pion_adverse, profondeur-1, nb_coup_joueur1, nb_coup_joueur2)
                        if( (i==0 and j==0) or (i==len(plateau)-1 and j==0) or (i==0 and j==len(plateau[0])-1) or (i==len(plateau)-1 and j==len(plateau[0])-1) ):  #DONC SI ON EST DANS UN COIN ON LE JOUE OBLIGATOIREMENT
                            nombre_a_jouer = plateau[i][j]
                            #print("On doit jouer le " + str(plateau[i][j]))
                            valeur = 10000000 #Alors on le joue obligatoirement
                            return valeur, nombre_a_jouer
        ...
        if(nb_coup_joueur2 == 0):
            ...
            score, _ = alpha_beta_ordi_mobilite("max", alpha, beta, plateau_bis, pion_de_lordi, pion_adverse, profondeur-1, nb_coup_joueur1, nb_coup_joueur2)
            if(score <= alpha):
                return alpha, nombre_a_jouer
            if(score < beta):
                beta = score
...
def alpha_beta_ordi_mixte(plateau, pion_de_lordi, pion_adverse, profondeur, nb_coup_joueur1, nb_coup_joueur2, coup_numero):
...
def jouer(indice, plateau, pion_joueur, pion_adverse, coup_numero, nb_coup_possible_joueur1, nb_coup_possible_joueur2, profondeur):
    ...
    if(indice == 1): #On a définit l'humain qui joue
        ...
        _, numero_a_jouer = min_max_ordi_positionnel("max", plateau, pion_joueur, pion_adverse, profondeur, nb_coup_possible_joueur1, nb_coup_possible_joueur2)
        
        if(numero_a_jouer != -1):
            plateau = jouer_numero(plateau, pion_joueur, numero_a_jouer)
            print("L'IA POSITIONNEL 'min-max' avec une profondeur de " + str(profondeur) + " à jouer sur le numéro " + str(numero_a_jouer) + "\n")
        else:
        ...
        _, numero_a_jouer = alpha_beta_ordi_positionnel("max", -1000000000, 1000000000, plateau, pion_joueur, pion_adverse, profondeur, nb_coup_possible_joueur1, nb_coup_possible_joueur2)
        
        if(numero_a_jouer != -1):
            plateau = jouer_numero(plateau, pion_joueur, numero_a_jouer)
            print("L'IA POSITIONNEL 'alpha-beta' avec une profondeur de " + str(profondeur) + " à jouer sur le numéro " + str(numero_a_jouer) + "\n")
        else:
        ...
        _, numero_a_jouer = min_max_ordi_absolu("max", plateau, pion_joueur, pion_adverse, profondeur, nb_coup_possible_joueur1, nb_coup_possible_joueur2)
        
        if(numero_a_jouer != -1):
            plateau = jouer_numero(plateau, pion_joueur, numero_a_jouer)
            print("L'IA ABSOLU 'min-max' avec une profondeur de " + str(profondeur) + " à jouer sur le numéro " + str(numero_a_jouer) + "\n")
        else:
        ...
        _, numero_a_jouer = alpha_beta_ordi_absolu("max", -1000000000000, 1000000000000, plateau, pion_joueur, pion_adverse, profondeur, nb_coup_possible_joueur1, nb_coup_possible_joueur2)

        if(numero_a_jouer != -1):
            plateau = jouer_numero(plateau, pion_joueur, numero_a_jouer)
            print("L'IA ABSOLU 'alpha-beta' avec une profondeur de " + str(profondeur) + " à jouer sur le numéro " + str(numero_a_jouer) + "\n")
        else:
        ...
        _, numero_a_jouer = min_max_ordi_mobilite("max", plateau, pion_joueur, pion_adverse, profondeur, nb_coup_possible_joueur1, nb_coup_possible_joueur2)
        
        if(numero_a_jouer != -1):
            plateau = jouer_numero(plateau, pion_joueur, numero_a_jouer)
            print("L'IA MOBILITE 'min-max' avec une profondeur de " + str(profondeur) + " à jouer sur le numéro " + str(numero_a_jouer) + "\n")
        else:
        ...
        _, numero_a_jouer = alpha_beta_ordi_mobilite("max", -1000000000, 1000000000, plateau, pion_joueur, pion_adverse, profondeur, nb_coup_possible_joueur1, nb_coup_possible_joueur2)
        
        if(numero_a_jouer != -1):
            plateau = jouer_numero(plateau, pion_joueur, numero_a_jouer)
            print("L'IA MOBILITE 'alpha-beta' avec une profondeur de " + str(profondeur) + " à jouer sur le numéro " + str(numero_a_jouer) + "\n")
        else:
        ...
        plateau = min_max_ordi_mixte(plateau, pion_joueur, pion_adverse, profondeur, nb_coup_possible_joueur1, nb_coup_possible_joueur2, coup_numero)
        return plateau
    elif(indice == 9): #On a définit l'IA ALPHA-BETA avec la strategie MIXTE
        #return jouer_ordi_mixte(plateau, pion_joueur, pion_adverse, coup_numero)     #PREMIER FONCTION TEST POUR LA COMPREHENSION
        plateau = alpha_beta_ordi_mixte(plateau, pion_joueur, pion_adverse, profondeur, nb_coup_possible_joueur1, nb_coup_possible_joueur2, coup_numero)
        return plateau



def jouer_silencieux(indice, plateau, pion_joueur, pion_adverse, coup_numero, nb_coup_possible_joueur1, nb_coup_possible_joueur2, profondeur):
    ...
    if(indice == 1): #On a définit l'humain qui joue
        ...
        #return jouer_ordi_mixte(plateau, pion_joueur, pion_adverse, coup_numero)     #PREMIER FONCTION TEST POUR LA COMPREHENSION
        plateau = min_max_ordi_mixte_silencieux(plateau, pion_joueur, pion_adverse, profondeur, nb_coup_possible_joueur1, nb_coup_possible_joueur2, coup_numero)
        return plateau
    elif(indice == 9): #On a définit l'IA ALPHA-BETA avec la strategie MIXTE
        #return jouer_ordi_mixte(plateau, pion_joueur, pion_adverse, coup_numero)     #PREMIER FONCTION TEST POUR LA COMPREHENSION
        plateau = alpha_beta_ordi_mixte_silencieux(plateau, pion_joueur, pion_adverse, profondeur, nb_coup_possible_joueur1, nb_coup_possible_joueur2, coup_numero)
        return plateau
    
def alpha_beta_ordi_mixte_silencieux(plateau, pion_de_lordi, pion_adverse, profondeur, nb_coup_joueur1, nb_coup_joueur2, coup_numero):
    """ Fonction qui fait la même chose que "alpha_beta_ordi_mixte" mais de facon silencieux
    """
    coup_possible_max_sur_plateau = len(plateau) * len(plateau[0])
    if(coup_numero > 0 and coup_numero < 25):
        return jouer_silencieux(3, plateau, pion_de_lordi, pion_adverse, coup_numero, nb_coup_joueur1, nb_coup_joueur2, profondeur)
    elif(coup_numero >= 25 and coup_numero < (coup_possible_max_sur_plateau - 16)):
        return jouer_silencieux(7, plateau, pion_de_lordi, pion_adverse, coup_numero, nb_coup_joueur1, nb_coup_joueur2, profondeur)
    else: #(coup_numero >= (coup_possible_max_sur_plateau - 16) and coup_numero < coup_possible_max_sur_plateau)
        return jouer_silencieux(5, plateau, pion_de_lordi, pion_adverse, coup_numero, nb_coup_joueur1, nb_coup_joueur2, profondeur)

def min_max_ordi_mixte_silencieux(plateau, pion_de_lordi, pion_adverse, profondeur, nb_coup_joueur1, nb_coup_joueur2, coup_numero):
    """ Fonction qui fait la même chose que "min_max_ordi_mixte" mais de facon silencieux
    """
    coup_possible_max_sur_plateau = len(plateau) * len(plateau[0])
    if(coup_numero > 0 and coup_numero < 25):
        return jouer_silencieux(2, plateau, pion_de_lordi, pion_adverse, coup_numero, nb_coup_joueur1, nb_coup_joueur2, profondeur)
    elif(coup_numero >= 25 and coup_numero < (coup_possible_max_sur_plateau - 16)):
        return jouer_silencieux(6, plateau, pion_de_lordi, pion_adverse, coup_numero, nb_coup_joueur1, nb_coup_joueur2, profondeur)
    else: #(coup_numero >= (coup_possible_max_sur_plateau - 16) and coup_numero < coup_possible_max_sur_plateau)
        return jouer_silencieux(4, plateau, pion_de_lordi, pion_adverse, coup_numero, nb_coup_joueur1, nb_coup_joueur2, profondeur)
...
if(mode_de_jeu == 1):
    ...
    while(est_plein(plateau) == False and (nb_coup_possible_joueur1 > 0 or nb_coup_possible_joueur2 > 0)): #Si le tableau est plein ou que aucun des 2 joueurs ne peut jouer
        ...
        if(joueur == 1):    #Si C'est le joueur 1 qui joue
            ...
            afficher_plateau(plateau)
            plateau = jouer(indice_joueur1, plateau, "☺", "☻", coup_numero, nb_coup_possible_joueur1, nb_coup_possible_joueur2, profondeur_joueur1)
            plateau = supprimer_coup_possible(plateau)
            ...
            afficher_plateau(plateau)
            plateau = jouer(indice_joueur2, plateau, "☻", "☺", coup_numero, nb_coup_possible_joueur2, nb_coup_possible_joueur1, profondeur_joueur2)
            plateau = supprimer_coup_possible(plateau)
    ...
    with open("resultat.txt", 'wb', 0) as f:
        f.write(bytes('profondeur IA:1vs1,1vs2,1vs3,1vs4,1vs5,2vs1,2vs2,2vs3,2vs4,2vs5,3vs1,3vs2,3vs3,3vs4,3vs5,4vs1,4vs2,4vs3,4vs4,4vs5,5vs1,5vs2,5vs3,5vs4,5vs5\n', 'utf-8'))
            ...
            for indice_joueur2 in range(3, 10, 2):
                ...
                for profondeur_joueur1 in range(1, 6):
                    for profondeur_joueur2 in range(1, 6):
                        ...
                        print("Evaluation de l'IA n°" + str(indice_joueur1) + " avec une profondeur de " + str(profondeur_joueur1) + " contre l'IA n°" + str(indice_joueur2) + " avec une profondeur de " + str(profondeur_joueur2) + ".......")
                        ...
                        while(est_plein(plateau) == False and (nb_coup_possible_joueur1 > 0 or nb_coup_possible_joueur2 > 0)): #Si le tableau est plein ou que aucun des 2 joueurs ne peut jouer
                            ...
                            if(joueur == 1):    #Si C'est le joueur 1 qui joue
                                ...
                                plateau, nb_coup_possible_joueur1 = coup_possible(plateau, "☻", "☺")
                                #afficher_plateau(plateau)
                                plateau = jouer_silencieux(indice_joueur1, plateau, "☺", "☻", coup_numero, nb_coup_possible_joueur1, nb_coup_possible_joueur2, profondeur_joueur1)
                                plateau = supprimer_coup_possible(plateau)
                                joueur = 2 #On donne le jeu à l'autre joueur
                            else: #if(joueur == 2): #Si C'est le joueur 2 qui joue
                                coup_numero += 1
                                ...
                                plateau, nb_coup_possible_joueur2 = coup_possible(plateau, "☺", "☻")
                                #afficher_plateau(plateau)
                                plateau = jouer_silencieux(indice_joueur2, plateau, "☻", "☺", coup_numero, nb_coup_possible_joueur2, nb_coup_possible_joueur1, profondeur_joueur2)
                                plateau = supprimer_coup_possible(plateau)
                                joueur = 1 #On donne le jeu à l'autre joueur
                            #print("\n-------------------------------------------------------\n")
                        ...
                        print("\n\nFIN DE LA PARTIE DE JEU!!!\n" +
                              "Il y a " + str(nb_pion1) + " pions ☺ VS " + str(nb_pion2) + " pions ☻")
                        if(nb_pion1 == nb_pion2):
                            print("\nLe joueur 1 (l'IA n°" + str(indice_joueur1) + " avec une profondeur de " + str(profondeur_joueur1) + ") est à égalité contre le joueur 2 (l'IA n°" + str(indice_joueur2) + " avec une profondeur de " + str(profondeur_joueur2))
                            result_.append(0)
                            #print(str(result_))
                        elif(nb_pion1 > nb_pion2):    
                            print("\nLe joueur 1 (l'IA n°" + str(indice_joueur1) + " avec une profondeur de " + str(profondeur_joueur1) + ") à gagner contre le joueur 2 (l'IA n°" + str(indice_joueur2) + " avec une profondeur de " + str(profondeur_joueur2))
                            result_.append(1)
                            #print(str(result_))
                        else:
                            print("\nLe joueur 2 (l'IA n°" + str(indice_joueur2) + " avec une profondeur de " + str(profondeur_joueur2) + ") à gagner contre le joueur 1 (l'IA n°" + str(indice_joueur1) + " avec une profondeur de " + str(profondeur_joueur1))
                            result_.append(2)
                            #print(str(result_))
    ...
    for i in range(len(plateau)):
        for j in range(len(plateau[0])):
            if( isinstance(plateau[i][j], int) ): #SI plateau[i][j] EST UN ENTIER
                ...
                nb_pion1, nb_pion2 = compter_pion(temp_plateau, pion_de_lordi, pion_adverse) #On compte les pions sur la simulation
...
def jouer_ordi_mobilite(plateau, pion_de_lordi, pion_adverse):
    ...
    for i in range(len(plateau)):
        for j in range(len(plateau[0])):
            if( isinstance(plateau[i][j], int) ): #SI plateau[i][j] EST UN ENTIER
                if( (i==0 and j==0) or (i==len(plateau)-1 and j==0) or (i==0 and j==len(plateau[0])-1) or (i==len(plateau)-1 and j==len(plateau[0])-1) ):
                    numero_retenu = plateau[i][j]
                    break #break de la double loop grâce au "else: continu     break"
                else :    
                    temp_plateau = copy.deepcopy(plateau) #Réalise une deep copy du plateau de jeu
                    jouer_numero(temp_plateau, pion_de_lordi, plateau[i][j]) #On simule le fait que l'on jou sur la case
                    poubelle, nb_coup_possible_pion2_apres_coup = coup_possible(temp_plateau, pion_de_lordi, pion_adverse) #On compte les pions sur la simulation
